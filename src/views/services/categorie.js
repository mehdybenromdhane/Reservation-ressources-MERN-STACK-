      ...
      <main>
        ...
        <section className="pb-20 bg-blueGray-200 -mt-24">
          <div className="container mx-auto px-4">
            ...
            <form className="md:flex hidden md:w-4/12   ">
              <div className="relative flex w-full flex-wrap justify-end ">
                <span className="z-40 h-full leading-snug font-normal absolute text-center text-blueGray-300 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3">
                ...
                <Card>
                  ...
                  <CardFooter className="flex justify-between">
                    <Button color="lightBlue" size="lg" ripple="light">
                      Save <FontAwesomeIcon icon="heart" />
                    </Button>
                    <div className="flex justify-content">
                      <FontAwesomeIcon
                        icon="star"
