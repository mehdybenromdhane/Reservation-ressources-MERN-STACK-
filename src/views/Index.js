      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className=" relative container mx-auto">
          <div className="    relative flex flex-wrap items-center">
            <Carousel itemsToShow={2} className={"slider"}>
              <div className="w-10/12  relative px-12 md:px-4 mr-auto ml-auto -mt-32">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <Link
                      className="text-white text-sm font-bold leading-relaxed inline-block  whitespace-nowrap uppercase"
                      to="/categorie"
                    >
              ...
              <div className="w-10/12  relative px-12 md:px-4 mr-auto ml-auto -mt-32">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <h4 className="text-xl font-bold text-white">WordPress </h4>
                    <p className="text-md font-light mt-2 text-white">
                      Putting together a page has never been easier than
                      matching together pre-made components. From landing pages
                      presentation to login areas, you can easily customise and
              ...
              <div className="w-10/12  relative px-12 md:px-4 mr-auto ml-auto -mt-32">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <h4 className="text-xl font-bold text-white">Full Stack</h4>
                    <p className="text-md font-light mt-2 text-white">
                      Putting together a page has never been easier than
                      matching together pre-made components. From landing pages
                      presentation to login areas, you can easily customise and
              ...
              <div className="w-10/12  relative px-12 md:px-4 mr-auto ml-auto -mt-32">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <h4 className="text-xl font-bold text-white">Réseau</h4>
                    <p className="text-md font-light mt-2 text-white">
                      Putting together a page has never been easier than
                      matching together pre-made components. From landing pages
                      presentation to login areas, you can easily customise and
